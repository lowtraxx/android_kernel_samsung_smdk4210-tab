...
#elif defined(CONFIG_TOUCHSCREEN_ATMEL_MXT224_GRANDE)
#include <linux/delay.h>
...
#if defined(CONFIG_TOUCHSCREEN_ATMEL_MXT224_U1)\
|| defined(CONFIG_TOUCHSCREEN_ATMEL_MXT224_GRANDE)
/* mxt224 TSP */
...
static u8 t8_config_e[] = {GEN_ACQUISITIONCONFIG_T8,
	27, 0, 5, 1, 0, 0, 4, 35, 0, 0};
/* MXT224E_0V5_CONFIG */
/* NEXTTCHDI added */
static u8 t9_config_e[] = {TOUCH_MULTITOUCHSCREEN_T9,
	139, 0, 0, 19, 11, 0, 32, 50, 2, 7,
	10,
	15,		/* MOVHYSTI */
...
static u8 t48_config_e[] = {PROCG_NOISESUPPRESSION_T48,
	3, 132, 66/*64*/, 0, 0, 0, 0, 10, 15, 0,
	0, 0, 0, 6, 6, 0, 0, 48, 4, 40/*48*/,
...
static struct mxt224_platform_data mxt224_data = {
	...
	.t46_ta_cfg = t46_config_e_ta,
	.t48_ta_cfg = t48_config_e_ta,/*TSP TA noise 201107251027*/
	.min_x = 0,
	.max_x = 480,
	.min_y = 0,
	.max_y = 800,
	...
	/*.orient_barnch = mxt224_orient_branch, TSP TA noise 201107251027*/
	.read_ta_status = tsp_read_ta_status,/*TSP TA noise 201107251027*/
};
#else
static struct mxt224_platform_data mxt224_data = {
	.max_finger_touches = MXT224_MAX_MT_FINGERS,
...
static struct melfas_tsi_platform_data mms_ts_pdata = {
	...
	.tsp_vendor = "MELFAS",
	.tsp_ic	= "MMS136",
	.tsp_tx = 19,	/* TX_NUM (Reg Addr : 0xEF) */
	.tsp_rx = 11,	/* RX_NUM (Reg Addr : 0xEE) */
	.fw_version = 0x02,
