/*
 *  linux/arch/arm/mach-exynos/board-grande-gpio.c
 *
...
/*
 * GRANDE GPIO Sleep Table
 */
static unsigned int grande_sleep_gpio_table[][3] = {
	...
	/* FOLDER_PMIC_SDA */
	{EXYNOS4_GPF0(4), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},
	{EXYNOS4_GPF0(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /* NC */
	/* FOLDER_PMIC_SCL */
	{EXYNOS4_GPF0(6), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},
	/* SUB_PMIC_SDA */
	{EXYNOS4_GPF0(7), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},

	/* SUB_PMIC_SCL */
	{EXYNOS4_GPF1(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_UP},
...
void midas_config_sleep_gpio_table(void)
{
	...
	config_sleep_gpio_table(ARRAY_SIZE(grande_sleep_gpio_table),
			grande_sleep_gpio_table);
#endif
}
