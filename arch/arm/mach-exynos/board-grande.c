...
static struct regulator_consumer_supply sub_pmic_ldo1_supply[] = {
	REGULATOR_SUPPLY("vtp_2.8v", NULL),
};

static struct regulator_consumer_supply sub_pmic_ldo2_supply[] = {
	REGULATOR_SUPPLY("vcc_2.8v_mag", NULL),
};
...
REGULATOR_INIT(sub_pmic_ldo2, "VCC_2.8V_MAG", 3000000, 3000000, 0,
	       REGULATOR_CHANGE_STATUS, 1);

REGULATOR_INIT(sub_pmic_ldo3, "CAM_ISP_MIPI_1.2V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);

REGULATOR_INIT(sub_pmic_ldo4, "CAM_ISP_SENSOR_IO_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
...
static struct lp8720_regulator_subdev lp8720_sub_regulators[] = {
	...
	{ LP8720_LDO2, &sub_pmic_ldo2_init_data, },
